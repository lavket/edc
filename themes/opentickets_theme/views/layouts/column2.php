...
<!-- header -->
    <div id="page-top-outer">
      ...
      <div id="page-top">
        <!-- start logo -->
          ...
          <a href="http://www.adlabsimagica.com" target='_blank'><img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/Legacy/Home.png" alt="" /></a>
          <a href=""><img class="thumbnail1" src="<?php echo Yii::app()->theme->baseUrl; ?>/images/Legacy/TheLegacy.jpg" width="300" height="90" alt="" /></a>
		  <a href="http://adlabsentertainment.com/awaz/index.aspx" target='_blank'><img class="thumbnail2" src="<?php echo Yii::app()->theme->baseUrl; ?>/images/Legacy/rules.png" width="100" height="80" alt="" /></a>
		  <!--<a href=""><img class="thumbnail3" src="<?php //echo Yii::app()->theme->baseUrl; ?>/images/Legacy/open_pass_right.jpg" width="100" height="75" alt="" /></a>-->
	...
	<?php //if(!isset(Yii::app()->session['login']) && (Yii::app()->session['login'] == '')){  ?>
              ...
              <ul class="menu">
					<?php if(Yii::app()->user->isGuest) {?>
						...
						<li><?php echo CHtml::link("<span>Apply</span>", array('/recruitment/index')); ?></li>
					<?php } ?>
					
					<?php if(!Yii::app()->user->isGuest) { ?>
						<li><?php echo CHtml::link("<span>Dashboard</span>", array('/site/index')); ?></li>
						<li><?php echo CHtml::link("<span>Apply</span>", array('/recruitment/index')); ?></li>
						<li><?php echo CHtml::link("<span>Pending Applications</span>", array('/recruitmentform/pending')); ?></li>
						<li><?php echo CHtml::link("<span>Approved Applications</span>", array('/recruitmentform/cleared')); ?></li>
						<li><?php echo CHtml::link("<span>Rejected Applications</span>", array('/recruitmentform/rejected')); ?></li>
					<?php } ?>	
			  </ul>
	...
	<?php if(Yii::app()->session['login_user'] == "Admin") { ?>	
			 ...
			 <ul class="menu">
					<li><?php echo CHtml::link("<span>Dashboard</span>", array('/site/index')); ?></li>
					<li><?php echo CHtml::link("<span>Apply</span>", array('/recruitmentform/create')); ?></li>
					<li><?php echo CHtml::link("<span>Pending Applications</span>", array('/recruitmentform/pending')); ?></li>
					<li><?php echo CHtml::link("<span>Approved Applications</span>", array('/recruitmentform/cleared')); ?></li>
					<li><?php echo CHtml::link("<span>Rejected Applications</span>", array('/recruitmentform/rejected')); ?></li>
 ...
 <!--  start nav-outer-repeat................................................... END -->
    ...
    <div id="footer">
     ...
     <!-- <div id="footer-left"> &copy; Copyright <b>Adlabs</b> Entertainment Ltd .All rights reserved.</div>-->
	  <div id="footer-left"> &copy; Copyright The Legacy <!--<img src="<?php //echo Yii::app()->theme->baseUrl; ?>/images/shared/AdlabsName.jpg" alt="" />-->. All rights reserved.</div>
      <div id="copyright">&copy; Developed By <b>Lavket</b></div>
      <!--  end footer-left -->
      <div class="clear">&nbsp;</div>
    </div>
    <!-- end footer -->
