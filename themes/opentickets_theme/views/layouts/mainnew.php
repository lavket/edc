    ...
    <div id="page-top-outer">
      ...
      <div id="page-top">
        <!-- start logo -->
          ...
          <a href="http://adlabsentertainment.com/awaz/index.aspx" target='_blank'><img class="thumbnail4" src="<?php 	echo Yii::app()->theme->baseUrl; ?>/images/shared/imagica.jpg" alt="" /></a>
          <a href=""><img class="thumbnail1" src="<?php echo Yii::app()->theme->baseUrl; ?>/images/shared/edc_center.jpg" width="300" height="90" alt="" /></a>
		  <a href="http://thelegacycoc.shivtr.com/pages/clanrules" target='_blank'><img class="thumbnail2" src="<?php echo Yii::app()->theme->baseUrl; ?>/images/shared/edc_right.jpg" width="100" height="80" alt="" /></a>
